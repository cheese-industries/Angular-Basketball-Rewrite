...
@Component({
  selector: 'app-korn-ferry-tour',
  templateUrl: './korn-ferry-tour.component.html',
  styleUrls: ['./korn-ferry-tour.component.css']
})
@Injectable({
  providedIn: 'root',
})
export class KornFerryTourComponent implements OnInit {
  data!: PgaData;
  form: FormGroup;
  pipe = new DatePipe('en-us');
  myControl: FormControl = new FormControl();
  constructor(private service: KornFerryTourService) { 
