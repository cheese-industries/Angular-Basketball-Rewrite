...
@Component({
  selector: 'app-g-league',
  templateUrl: './g-league.component.html',
  styleUrls: ['./g-league.component.css'],
})
@Injectable({
  providedIn: 'root',
})
export class GLeagueComponent implements OnInit {
  data!: GameData;
